...
for z in range(200):
	...
	ua = f"Dalvik/2.1.0 (Mozilla/5.0 (Linux; Android 10; CPH2185) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36838/4845;]"
...
{color_text}│ {P2}Author : Haikal Saputra XD {color_text}│{color_text}│ {P2}Version : 2.0 {color_text}│{color_text}│ {P2}Dont't Recode My Tools Bro {color_text}│
